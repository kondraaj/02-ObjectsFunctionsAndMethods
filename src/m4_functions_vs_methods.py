...
def try_methods():
    meatball = rg.SimpleTurtle()
    meatball.pen = rg.Pen('brown', 5)
    meatball.forward(150)
    meatball.left(90)
    meatball.forward(50)
    meatball.backward(100)
...
def try_methods_and_functions():
    pudding = rg.SimpleTurtle()
    pudding.pen = rg.Pen('blue', 5)
    pudding.backward(150)
    pudding.speed = 1
    draw_many_squares(pudding, 2, 100, 30)
    pudding.speed = 5
    pudding.pen.color = 'red'
    draw_many_squares(pudding, 10, 50, 15)
    pudding.speed = 100
    pudding.pen.thickness = 35
    draw_many_squares(pudding, 8, 300, 60)
    pudding.pen = rg.Pen('black', 3)
    pudding.backward(200)
    pudding.draw_circle(30)
    pudding.draw_square(50)
