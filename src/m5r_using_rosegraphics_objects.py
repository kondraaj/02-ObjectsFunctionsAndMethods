...
#                radius, center_point, color
#
#     f. What does a RoseWindow RENDER method do?
#            creates the window, actually draws all of the things you want to draw
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            when a RoseWindow is opened, it will automatically close with this
#
